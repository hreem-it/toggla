      ...
      <div className="border-t border-gray-200 px-4 py-5 sm:px-6">
        <dl className="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2">
            ...
            <dd className="mt-1 text-sm text-gray-900">{toggle.description}</dd>
          </div>
          <div className="sm:col-span-2">
            ...
            <dd className="mt-1 text-sm text-gray-900">
              ...
              >
                {toggle?.variations
                  ?.filter((variation) => variation.variationKey !== "default")
                  .map((variation) => (
                        ...
                        <div className="flex items-center justify-between pt-1 pb-5">
                          <div className="w-0 flex-1 flex items-center">
                            <span className="text-gray-500 ">
                              <p className="mt-1 max-w-2xl text-sm text-gray-500">
                                GET {process.env.REACT_APP_BE_API_URL}/toggles/
